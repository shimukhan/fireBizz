...
$('.case-active').slick({
	...
	slidesToShow: 4,
	slidesToScroll: 1,
	prevArrow:'<button type="button" class="slick-prev"><span class="lnr lnr-arrow-left"></span></button>',
	nextArrow:'<button type="button" class="slick-next"><span class="lnr lnr-arrow-right"></span></button>',
	arrows: true,
	responsive: [
	  {
		breakpoint: 1024,
